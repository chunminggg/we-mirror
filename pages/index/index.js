...
Page({
  ...
  wx.navigateTo({
    url: `../specialList/sepicalList?name=isSpecialPrice&title=特价项目`,
  })
  },
  clickMoreFree(){
    wx.navigateTo({
      url: `../specialList/sepicalList?name=isFreeTravel&title=百安丽`   ,
    })
  },
  clickMoreRecommend(){
    wx.navigateTo({
      url: `../specialList/sepicalList?name=isRecommend&title=店长推荐`, 
    })
  },
  clickMoreFollow(){
    wx.navigateTo({
      url: `../specialList/sepicalList?name=isFollowTeam&title=特色项目`,
    })
  },
  clickImageidx(e) {
